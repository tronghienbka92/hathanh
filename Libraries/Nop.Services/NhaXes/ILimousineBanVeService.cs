...
namespace Nop.Services.NhaXes
{
    public partial interface ILimousineBanVeService
    {
        ...
        List<ChuyenDi> GetAllChuyenDiTrongNgay(int NhaXeId, int HanhTrinhId, DateTime NgayDi);
        ...
        HanhTrinhLoaiXeGiaVe GetHanhTrinhLoaiXeGiaVe(int HanhTrinhId, int LoaiXeId, int SoDoGheQuyTacId);
