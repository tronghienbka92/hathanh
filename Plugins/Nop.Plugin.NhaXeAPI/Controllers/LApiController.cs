...
namespace Nop.Plugin.NhaXeAPI.Controllers
{
    public class LApiController : BaseController
    {
        ...
        public ActionResult GetSoDoGheXe(string codename, int ChuyenDiId, string checksum)
        {
            ...
            var sodoghequytacs = _xeinfoService.GetAllSoDoGheXeQuyTac(xexuatben.lichtrinh.loaixe.Id);
            ...
            foreach (var sodo in sodoghequytacs)
            {
                ...
                if (phoive == null)
                {
                    ...
                    phoive.GiaTien=_limousinebanveService.GetGiaVeTheoSoDoId(xexuatben.HanhTrinhId, xexuatben.lichtrinh.loaixe.Id, sodo.Id);
